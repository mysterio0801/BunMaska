...
const { postRegister, 
        ...
        deleteUser, 
        getUserDetails,
        updateUserDetails } = require('../controllers/authControllers');
...
router.patch('/updateDistributorInfo', auth, updateUserDetails) //Get Distributor Details

// --------> Menu List routes <--------
router.get('/getMenuList/:vendor_id', getMenuList) //Get MenuList of a vendor
